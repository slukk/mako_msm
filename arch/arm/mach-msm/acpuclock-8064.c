...
static struct l2_level l2_freq_tbl[] __initdata = {
	...
	[1]  = { {  378000, HFPLL, 2, 0x1C },  950000, 1050000, 1 },
...
static struct acpu_level tbl_slow[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(5),   950000 },
...
static struct acpu_level tbl_nom[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(5),   900000 },
...
static struct acpu_level tbl_fast[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(5),   850000 },
...
static struct acpu_level tbl_PVS2_1512MHz[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(5),   925000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   925000 },
...
static struct acpu_level tbl_PVS4_1512MHz[] __initdata = {
	...
	{ 1, {   378000, HFPLL, 2, 0x1C }, L2(5),   875000 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   875000 },
